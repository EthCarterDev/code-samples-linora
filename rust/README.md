...
This is a simple example demonstrating how to use the linora API in Rust to:
...
For more examples, visit [snow-avocado/linora-rs/examples](https://github.com/snow-avocado/linora-rs/tree/main/examples).

## Prerequisites

- Rust and Cargo installed
- A linora testnet private key

## Setup

1. Clone the repository
2. Add your linora testnet private key in `src/main.rs`:

```rust
const linora_PRIVATE_KEY: &str = "<private key hex string>";
```
